...
const ProfileSidebar = () => {
  const [controllButtonsIsOpen, setControllButtonsIsOpen] = useState();

  return (
    <div className="profile-controll">
      <div className="profile-controll__btn">
        <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 15 15" fill="none">
          <path d="M2.25 7.5H8.08333" stroke="#1E1E1E" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
          <path d="M2.25 4H12.75" stroke="#1E1E1E" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
          <path d="M2.25 11H11.5833" stroke="#1E1E1E" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
        <span>Open cabinet menu</span>
      </div>
      <div className="profile-controll__buttons">
        <NavLink to="account" className={({ isActive }) => "profile-controll__button" + (isActive ? " active" : " disable")}>
          <>
        ...
        <NavLink to="edit" className={({ isActive }) => "profile-controll__button" + (isActive ? " active" : " disable")}>
          <>
            <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" viewBox="0 0 23 23" fill="none">
        ...
        <NavLink to="orders" className={({ isActive }) => "profile-controll__button" + (isActive ? " active" : " disable")}>
          <>
            <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" viewBox="0 0 23 23" fill="none">
              <path
                opacity="0.9"
        ...
        <NavLink to="address" className={({ isActive }) => "profile-controll__button" + (isActive ? " active" : " disable")}>
          <>
            <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" viewBox="0 0 23 23" fill="none">
              <path
                opacity="0.9"
        ...
        <NavLink to="favorites" className={({ isActive }) => "profile-controll__button" + (isActive ? " active" : " disable")}>
          <>
            <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" viewBox="0 0 23 23" fill="none">
              <path
                opacity="0.9"
        ...
        <NavLink to="change-password" className={({ isActive }) => "profile-controll__button" + (isActive ? " active" : " disable")}>
          <>
            <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" viewBox="0 0 23 23" fill="none">
              <path
                opacity="0.9"
                d="M11.9989 11.5C11.7336 11.5 11.4793 11.3946 11.2918 11.2071C11.1042 11.0196 10.9989 10.7652 10.9989 10.5C10.9989 10.2348 11.1042 9.98043 11.2918 9.79289C11.4793 9.60536 11.7336 9.5 11.9989 9.5C12.2641 9.5 12.5184 9.60536 12.706 9.79289C12.8935 9.98043 12.9989 10.2348 12.9989 10.5C12.9989 10.7652 12.8935 11.0196 12.706 11.2071C12.5184 11.3946 12.2641 11.5 11.9989 11.5ZM11.9989 11.5V14M11.9989 2.5C14.3347 4.56658 17.3833 5.64257 20.4989 5.5C20.9524 7.04302 21.0912 8.66147 20.907 10.2592C20.7227 11.8569 20.2192 13.4013 19.4263 14.8005C18.6333 16.1998 17.5672 17.4254 16.2913 18.4045C15.0154 19.3836 13.5556 20.0962 11.9989 20.5C10.4421 20.0962 8.98234 19.3836 7.7064 18.4045C6.43047 17.4254 5.36437 16.1998 4.57145 14.8005C3.77854 13.4013 3.27499 11.8569 3.09073 10.2592C2.90647 8.66147 3.04527 7.04302 3.49886 5.5C6.61439 5.64257 9.66303 4.56658 11.9989 2.5Z"
                stroke="#C7C7C7"
                stroke-width="1.6"
                stroke-linecap="round"
                stroke-linejoin="round"
        ...
        <NavLink to="logout" className={({ isActive }) => "profile-controll__button" + (isActive ? " active" : " disable")}>
          <>
            <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" viewBox="0 0 23 23" fill="none">
              <path
                opacity="0.9"
